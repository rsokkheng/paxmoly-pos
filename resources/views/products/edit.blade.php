                ...
                <div class="card">
                            ...
                            <div class="form-text">
                                @if($product->isLowStock())
                                    <span style="color:var(--danger);">
                                        <i class="fas fa-exclamation-triangle"></i> Currently low stock
                                    </span>
                                @else
                    ...
                    <div style="background:var(--bg);border:1px solid var(--border);border-radius:var(--radius);padding:12px;display:flex;gap:24px;">
                        <div>
                            ...
                            <div id="marginVal" style="font-family:var(--mono);font-size:16px;">—</div>
                        </div>
                        <div>
                            <div class="form-label">Margin %</div>
                            <div id="marginPct" style="font-family:var(--mono);font-size:16px;">—</div>
                        </div>
                    </div>
                </div>
            </div>
...
updateMargin(); // populate on page load
