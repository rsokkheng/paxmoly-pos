...
@section('breadcrumb', 'Purchases / Create')
...
<div style="display:grid;grid-template-columns:1fr 300px;gap:16px;align-items:start;">
    ...
    <div style="display:flex;flex-direction:column;gap:16px;">
        <div class="card">
            ...
            <div id="noItemsMsg" style="text-align:center;color:var(--muted);padding:36px;font-size:13px;">
                <i class="fas fa-box-open" style="font-size:22px;display:block;margin-bottom:8px;opacity:.3;"></i>
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control" required>
                    ...
                    <option value="received" {{ old('status') === 'received' ? 'selected' : '' }}>
                        Received (adds stock now)
                    </option>
                </select>
                <div class="form-text">Setting to <em>Received</em> immediately updates stock quantities.</div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="paid_amount" id="paidAmount"
                       ...
                       value="{{ old('paid_amount', 0) }}" oninput="updateSummary()">
            </div>
...
// Reindex all rows sequentially before submit to ensure items[0], items[1]...
document.getElementById('purchaseForm').addEventListener('submit', function (e) {
    ...
    // Validate all unit_cost fields are filled
    let valid = true;
    rows.forEach(tr => {
        const i    = tr.dataset.idx;
    ...
    // Reindex: rename inputs to items[0], items[1]... sequentially
